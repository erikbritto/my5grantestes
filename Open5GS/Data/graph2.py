...
for arquivo in os.listdir(pasta):
    if arquivo.endswith(".csv"):
        ...
        if "div" in nome_arquivo:
            ...
            novo_nome_arquivo = f'graph_times_div_{nome_arquivo.split("_")[4]}_{nome_arquivo.split("_")[5]}_{nome_arquivo.split("_")[6]}.png'
            ...
            novo_nome_arquivo = f'graph_times_dec_{nome_arquivo.split("_")[4]}_{nome_arquivo.split("_")[5]}_{nome_arquivo.split("_")[6]}.png'
        else:
            title = f'Parallel Connection Test:\nInterval of {nome_arquivo.split("_")[3]}ms'
            novo_nome_arquivo = f'graph_times_{nome_arquivo.split("_")[1]}_{nome_arquivo.split("_")[3]}.png'
