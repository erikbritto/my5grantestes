...
for arquivo in os.listdir(pasta):
    if arquivo.endswith(".csv"):
        ...
        if "div" in nome_arquivo:
            ...
            novo_nome_arquivo = f'graph_connections_div_{nome_arquivo.split("_")[3]}_{nome_arquivo.split("_")[4]}_{nome_arquivo.split("_")[5]}.png'
            ...
            novo_nome_arquivo = f'graph_connections_dec_{nome_arquivo.split("_")[3]}_{nome_arquivo.split("_")[4]}_{nome_arquivo.split("_")[5]}.png'
        else:
            title = f'Parallel Connection Test:\nInterval of {nome_arquivo.split("_")[3]}ms'
            novo_nome_arquivo = f'graph_connections_{nome_arquivo.split("_")[2]}_{nome_arquivo.split("_")[3]}.png'
